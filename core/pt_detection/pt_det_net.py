...
'''
@Author: CaptainHu
@Date: 2021年 12月 09日 星期四 14:38:13 CST
@Description: 
'''
...
class PointDetectNet(nn.Module):
    ...
    def forward(self,x:torch.Tensor):
        ...
        x_mp_cls=self.meter_pt_cls(x).sigmoid()
        ...
        return x_scale_cls,s_coord,x_mp_cls,mp_coord
